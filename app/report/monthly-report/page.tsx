...
import { FirestoreDailyReport, MonthlyReport } from "@/app/types/report";
                    ...
                    <tr key={report.id}>
                      ...
                      <td className="px-6 py-4 whitespace-nowrap text-sm font-medium">
                        <Link href={`/report/monthly-report/${report.month}`}>
                          <button className="px-4 py-2 bg-primary-500 hover:bg-primary-600 text-white rounded transition duration-300 ease-in-out transform hover:scale-105">
                            View Details
                          </button>
                        </Link>
                      </td>
